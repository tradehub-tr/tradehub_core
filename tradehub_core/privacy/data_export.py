...
_EXPORTABLE_DOCTYPES = {
    ...
    "User Profile": {
        ...
        "fields": [
            "member_id", "status", "full_name", "phone", "country",
            "account_type", "company_name", "tax_id", "tax_id_type",
            "tax_office", "email_verified", "business_type",
            "year_established", "employee_count", "sourcing_frequency",
            "annual_spending", "joined_at", "created_via",
        ],
    },
    "Seller Profile": {
        "filters_field": "user",
        ...
        "fields": [
            "store_name", "store_slug", "description", "phone", "email",
            "city", "district", "address", "creation",
        ],
    },
    "Seller Application": {
        "filters_field": "user",
        ...
        "fields": [
            "company_name", "company_type", "tax_id", "tax_office",
            "status", "creation",
        ],
    },
    "Addresses": {
        ...
        "fields": [
            ...
            "city", "state", "country", "pincode", "phone", "purpose", "creation",
        ],
    },
    "Order": {
        "filters_field": "buyer",
        "label": "Siparişler",
        "fields": [
            "name", "status", "grand_total", "currency", "creation",
        ],
    },
    "Cart": {
        "filters_field": "user",
    ...
    "Listing Review": {
        ...
        "fields": [
            "listing", "rating", "title", "content", "status", "creation",
        ],
    },
    "Listing Question": {
        ...
        "label": "Sorular",
        "fields": [
            "listing", "question", "status", "creation",
        ],
    },
    "Search History": {
        "filters_field": "user",
    ...
    "User Consent Log": {
        ...
        "fields": [
            "consent_type", "action", "version", "source", "creation",
        ],
    },
}
