...
def execute():
	...
	content = [
			...
			"items": [
				{
					...
					"data": {
						...
						"link_to": "Listing",
						"type": "DocType",
						"icon": "es-line-package",
					},
				},
				{
					"id": "lnk-listing-variant",
					"type": "shortcut",
					"data": {
						"label": "İlan Varyantları",
						"format": "card",
						"link_to": "Listing Variant",
						"type": "DocType",
						"icon": "es-line-settings",
					},
				},
				{
					"id": "lnk-seller-product",
					"type": "shortcut",
					"data": {
						"label": "Satıcı Ürünleri",
						"format": "card",
						"link_to": "Seller Product",
						"type": "DocType",
						"icon": "es-line-tag",
					},
				},
			...
			"items": [
				...
				},
				{
					...
					"data": {
						...
						"type": "DocType",
						"icon": "es-line-tag-double",
					},
				},
				{
					"id": "lnk-shipping-method",
					"type": "shortcut",
					"data": {
		...
		},
		{
			...
			"items": [
				{
					"id": "lnk-seller-balance",
					"type": "shortcut",
					"data": {
						"label": "Bakiye",
						"format": "card",
						"link_to": "Seller Balance",
						"type": "DocType",
						"icon": "es-line-wallet",
					},
				},
				{
					"id": "lnk-seller-inquiry",
					"type": "shortcut",
					"data": {
						"label": "Sorgular",
						"format": "card",
						"link_to": "Seller Inquiry",
						"type": "DocType",
						"icon": "es-line-chat",
					},
				},
				{
					"id": "lnk-seller-review",
					"type": "shortcut",
					"data": {
						"label": "Değerlendirmeler",
						"format": "card",
						"link_to": "Seller Review",
						"type": "DocType",
						"icon": "es-line-star",
					},
				},
