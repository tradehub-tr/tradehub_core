...
class TestTopluDenetim(FrappeTestCase):
	...
	def test_kural_boyut_haritasinda_cwv_kodlari(self):
		...
		# Bütünlük: harita 35 kuralı kapsıyor (Dilim 8: + missing_localized_alt;
		# F-18b: + invalid_rights_date; MOGEM-620 §9: + expensive_decode) ve her
		# value gerçek bir DIMENSIONS üyesi — yazım hatası ("performnace" gibi)
		# skor toplamında sessizce yutulur.
		self.assertEqual(len(seo_audit._KURAL_BOYUT), 35)
