...
LOGISTICS_PROVIDERS: list[dict[str, Any]] = [
	{"provider_name": "Yurtici Kargo", "code": "YK", "country": "TR"},
	...
	{"provider_name": "Surat Kargo", "code": "SK", "country": "TR"},
...
# Severity + kategori + aksiyon TEK KAYNAK olarak v15_log034_seed_exception_codes.EXCEPTION_META'da
# tutulur — buradaki eski "severity" anahtari hic okunmadigi icin kaldirildi (P2-2).
