...
def list_transfers(status: str | None = None, tenant: str | None = None) -> list[dict]:
	...
	return frappe.get_all(
		...
		filters=filters,
		fields=[
			"name", "tenant", "current_owner", "proposed_owner", "status",
			"owner_confirmed_at", "super_admin_approved_at", "super_admin_approved_by",
			"effective_at", "is_force_transfer", "reason", "rejection_reason",
		],
